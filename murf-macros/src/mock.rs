    ...
    fn generate_expectation_module(
        ...
        self.result.expectation_modules.extend(quote! {
            mod #module {
                ...
                use murf::{Matcher, Times, TimesRange, Sequence, SequenceHandle, InSequence, action::{Action, RepeatableAction, OnetimeAction, RepeatedAction}};
...
impl TempLifetimes {
    ...
    fn generate(&mut self) -> Lifetime {
        ...
        let lt = format!("'murf_tmp_{}", self.count);
